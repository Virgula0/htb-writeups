...
<div class="js-stools" role="search">
    ...
    <div class="js-stools-container-selector">
        <?php echo LayoutHelper::render('searchtools.default.selector', $data, $basePath); ?>
    </div>
    <?php endif; ?>
    <div class="js-stools-container-bar">
        <div class="btn-toolbar">
            <?php echo LayoutHelper::render('searchtools.default.bar', $data, $basePath); ?>
            <?php echo LayoutHelper::render('searchtools.default.list', $data, $basePath); ?>
        </div>
    </div>
	<!-- Filters div -->
	<div class="js-stools-container-filters clearfix<?php echo $filtersActiveClass; ?>">
        <?php if ($data['options']['filterButton']) : ?>
            <?php echo LayoutHelper::render('searchtools.default.filters', $data, $basePath); ?>
        <?php endif; ?>
    </div>
</div>
<?php if ($data['options']['showNoResults']) : ?>
    <?php echo LayoutHelper::render('searchtools.default.noitems', $data, $basePath); ?>
<?php endif; ?>
