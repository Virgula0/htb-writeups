...
<div class="p-3">
    <div class="alert alert-info small">
        <ul>
            <?php echo Text::_('COM_JDOWNLOADS_BATCH_DOWNLOAD_NOTE'); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <div class="controls">
              <?php echo LayoutHelper::render('html.batch.price'); ?>
            </div>
        </div>
    </div>
    ...
    <div class="row">
            <div class="form-group col-md-12">
                <div class="controls">
                  ...
                  <?php echo LayoutHelper::render('html.batch.downloads', $this->categories, $basePath); ?>
                </div>
            </div>
    </div>
