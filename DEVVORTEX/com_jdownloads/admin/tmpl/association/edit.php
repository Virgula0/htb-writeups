...
use JDownloads\Component\JDownloads\Administrator\View\Association\HtmlView;

$wa = $this->document->getWebAssetManager();
$wa->useScript('keepalive')
    ->useScript('form.validate')
	->usePreset('com_jdownloads.sidebyside')
...
<button id="toggle-left-panel" class="btn btn-sm btn-secondary"
		data-show-reference="<?php echo Text::_('COM_JDOWNLOADS_ASSOCIATIONS_EDIT_SHOW_REFERENCE'); ?>"
		data-hide-reference="<?php echo Text::_('COM_JDOWNLOADS_ASSOCIATIONS_EDIT_HIDE_REFERENCE'); ?>"><?php echo Text::_('COM_JDOWNLOADS_ASSOCIATIONS_EDIT_HIDE_REFERENCE'); ?>
</button>

<form action="<?php echo ROUTE::_('index.php?option=com_jdownloads&view=association&' . http_build_query($options)); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" data-associatedview="<?php echo $this->typeName; ?>">
	<div class="sidebyside">
		<div class="outer-panel" id="left-panel">
			<div class="inner-panel">
				<h3><?php echo Text::_('COM_JDOWNLOADS_ASSOCIATIONS_REFERENCE_ITEM'); ?></h3>
		...
		<div class="outer-panel" id="right-panel">
			<div class="inner-panel">
				<div class="language-selector">
                    <div class="clearfix">
					    <h3 class="target-text"><?php echo Text::_('COM_JDOWNLOADS_ASSOCIATIONS_ASSOCIATED_ITEM'); ?></h3>
                    </div>
                    <div class="langtarget">
                        <div class="visually-hidden">
                            <?php echo $this->form->getLabel('JDItemlanguage'); ?>
                        </div>
