...
namespace JDownloads\Component\JDownloads\Administrator\View\Optionsexport; 
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::title(Text::_('COM_JDOWNLOADS').': '.Text::_('COM_JDOWNLOADS_OPTIONS_EXPORT'), 'cogs jdbackup');
        ...
        if ($canDo->get('core.admin', 'com_jdownloads') || $canDo->get('core.options', 'com_jdownloads')) {
            ToolBarHelper::custom( 'optionsexport.runexport', 'new', 'new', Text::_('COM_JDOWNLOADS_OPTIONS_EXPORT'), false, false ); 
