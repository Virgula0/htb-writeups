...
namespace JDownloads\Component\JDownloads\Administrator\View\Layouts; 
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        if ($canDo->get('core.edit')) {
            ToolBarHelper::custom( 'layouts.cssimport', 'upload.png', 'upload.png', Text::_('COM_JDOWNLOADS_CSS_IMPORT_LABEL'), false, false); 
        }
        if ($canDo->get('core.edit')) {
            ToolBarHelper::custom( 'layouts.cssexport', 'download.png', 'download.png', Text::_('COM_JDOWNLOADS_CSS_EXPORT_LABEL'), false, false); 
        }        
        ...
        $help_page = '139&tmpl=jdhelp';  // Article 'An introduction to Layouts'
