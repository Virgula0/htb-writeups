...
namespace JDownloads\Component\JDownloads\Administrator\View\Optionsimport; 
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::title(Text::_('COM_JDOWNLOADS').': '.Text::_('COM_JDOWNLOADS_OPTIONS_IMPORT'), 'cogs jdrestore');
