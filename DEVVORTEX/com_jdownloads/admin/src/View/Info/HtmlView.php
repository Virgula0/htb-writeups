...
namespace JDownloads\Component\JDownloads\Administrator\View\Info; 
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::title(Text::_('COM_JDOWNLOADS').': '.Text::_('COM_JDOWNLOADS_TERMS_OF_USE'), 'info jdinfo');
