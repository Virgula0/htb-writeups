...
namespace JDownloads\Component\JDownloads\Administrator\View\Restore; 
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::title(Text::_('COM_JDOWNLOADS').': '.Text::_('COM_JDOWNLOADS_RESTORATION'), 'cogs jdrestore');
