...
namespace JDownloads\Component\JDownloads\Administrator\View\Backup;
...
/**
 * View class for the backup view.
 *
 * @since  4.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::title(Text::_('COM_JDOWNLOADS').': '.Text::_('COM_JDOWNLOADS_BACKUP'), 'cogs jdbackup');
        ...
        if ($canDo->get('core.admin', 'com_jdownloads') || $canDo->get('core.options', 'com_jdownloads')) {
            ToolBarHelper::custom( 'backup.runbackup', 'new', 'new', Text::_('COM_JDOWNLOADS_BACKUP_CREATE_LINK_LABEL'), false, false ); 
