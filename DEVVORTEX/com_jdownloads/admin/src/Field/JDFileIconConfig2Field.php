 ...
 * @since 1.6
 */
class JDFileIconConfig2Field extends FileListField
{
     /**
     * The form field type.
     *
     ...
     */
     ...
     protected function getInput()
     {
        ...
        $pic_dir_path = Uri::root().'images/jdownloads/fileimages/flat_2/';
        ...
        $pic_list .= '<script language="javascript" type="text/javascript">'."
            if (document.adminForm.jform_file_pic_default_filename2.options.value != '-1'){
                jsimg=\"".Uri::root().'images/jdownloads/fileimages/flat_2/'."\" + getSelectedText( 'adminForm', 'jform_file_pic_default_filename2' );
            } else {
                jsimg='';
            }
