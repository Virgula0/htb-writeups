 ...
 * @since 1.6
 */
class JDFileIconConfigField extends FileListField
{
     /**
     * The form field type.
     *
     ...
     */
     ...
     protected function getInput()
     {
        ...
        $pic_dir_path = Uri::root().'images/jdownloads/fileimages/';
        ...
        $pic_list .= '<script language="javascript" type="text/javascript">'."
            if (document.adminForm.jform_file_pic_default_filename.options.value != '-1'){
                jsimg=\"".Uri::root().'images/jdownloads/fileimages/'."\" + getSelectedText( 'adminForm', 'jform_file_pic_default_filename' );
            } else {
                jsimg='';
            }
