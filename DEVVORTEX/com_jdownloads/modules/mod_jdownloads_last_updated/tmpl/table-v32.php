			...
			if ($view_date) {
                if ($files[$i]->modified){
                    if ($view_date_same_line){
                        $html .= '<td style="text-align:'.$date_alignment.';"><small>'.$view_date_text.'&nbsp;'.substr(HTMLHelper::Date($files[$i]->modified,$date_format),0,10).'</small></td>';
                    } else {
                        $html .= '</tr><tr><td style="text-align:'.$date_alignment.';"><small>'.$view_date_text.'&nbsp;'.substr(HTMLHelper::Date($files[$i]->modified,$date_format),0,10).'</small></td>';
                    }    
                }
            }
            $html .= '</tr>';
